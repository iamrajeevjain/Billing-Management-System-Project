...
public class newProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(163, 17, -1, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 622, 10));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 48, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, 250, -1));
        ...
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 622, 10));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 368, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 300, 250, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 250, -1));
        ...
        if (jTextField1.getText() != null && jTextField2.getText() != null) {
            ...
            String activate = (String) jComboBox1.getSelectedItem();
             ...
             UserServices userServices = new UserServices();
                ...
                userDTO.setDiscription(discription);
                userDTO.setActivate(activate);
                 int count;
                count = userServices.insertProduct(userDTO);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
     /*     DBUtil dbUtil = new DBUtil();
        ...
        try {
            ...
            pstmt = connection.prepareStatement("select max(pId) from product");
